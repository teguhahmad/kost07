      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100">
          <div className="p-6">
            ...
            <p className="mt-1 text-sm text-blue-600">6 bulan terakhir</p>
          </div>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-yellow-50 to-yellow-100">
          <div className="p-6">
            ...
            <p className="mt-1 text-sm text-yellow-600">Bulan ini</p>
          </div>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-red-50 to-red-100">
          <div className="p-6">
            ...
            <p className="mt-1 text-sm text-red-600">Total tertunggak</p>
          </div>
        </Card>
      </div>
