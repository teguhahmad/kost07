...
import { Save, Bell, Lock, Building2, Mail, CheckCircle, Globe, X, Eye, EyeOff } from 'lucide-react';
            ...
            <div className="flex items-center justify-between">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={() => handleNotificationChange('newTenants')}
                  className="sr-only peer"
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
              </label>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    max="30"
                    value={settings.paymentReminder.daysBeforeDueDate}
                    onChange={(e) => setSettings(prev => ({
                      ...prev,
                      paymentReminder: {
                        ...prev.paymentReminder,
                        daysBeforeDueDate: parseInt(e.target.value) || 5
                      }
                    }))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
