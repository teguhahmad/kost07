...
const BackofficeProperties: React.FC = () => {
  ...
  const loadProperties = async () => {
    try {
      ...
      // Load all properties with owner information from users table
      const { data: propertiesData, error: propertiesError } = await supabase
        .from('properties')
        .select(`
          *,
          users!properties_owner_id_fkey(email)
        `)
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <Badge className="bg-blue-100 text-blue-800">
                          {stats?.occupancy_rate.toFixed(0)}% Occupied
                        </Badge>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="bg-gray-50 p-3 rounded-lg">
                          ...
                          <p className="font-semibold text-gray-900">
                            {stats?.occupied_rooms || 0}/{stats?.total_rooms || 0}
                          </p>
                        </div>
